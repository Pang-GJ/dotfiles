...
require "user.plugins_conf.nvim-tree"
require "user.plugins_conf.bufferline"
require "user.plugins_conf.lualine"
require "user.plugins_conf.toggleterm"
require "user.plugins_conf.project"
require "user.plugins_conf.indent"
require "user.plugins_conf.alpha"
require "user.plugins_conf.trouble"
require "user.plugins_conf.whichkey"
require "user.plugins_conf.symbols-outline"
